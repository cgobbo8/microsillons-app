...
export const InfiniteArticles = ({ articles, categorySelected, authorSlug = null }) => {
        ...
        <>
            ...
            >
                {articlesToShow.map((data, index) => (
                    <a onClick={(e) => handleOpenBlog(e, data.attributes.slug)} href={`/blog/${data.attributes.slug}`} className={`${styles['infinite_articles__article']} ${data.attributes.important ? 'important' : ''}`} key={index}>
